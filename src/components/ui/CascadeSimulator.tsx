    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 dark:bg-black/75 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0b1322] text-slate-900 dark:text-slate-100 shadow-2xl transition-colors">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-slate-50 dark:bg-white/[0.03] rounded-xl p-4 border border-slate-200 dark:border-white/[0.06]">
            <div className="md:col-span-2">
              ...
              <select
                ...
                className="w-full rounded-lg bg-white dark:bg-[#121c30] border border-slate-300 dark:border-white/10 px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 shadow-2xs"
              >
                {roads.map((road) => (
            ...
            <div className="flex items-end gap-2">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-white dark:bg-white/[0.05] text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors border border-slate-200 dark:border-white/10 cursor-pointer shadow-2xs"
              >
