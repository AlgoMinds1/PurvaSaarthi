...
export const AIExplainabilityDrawer: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg h-full overflow-y-auto bg-slate-900 border-l border-slate-800 text-slate-100 shadow-2xl p-6 space-y-6">
        {/* Header */}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-4 rounded-xl border border-red-500/30 bg-red-500/10 space-y-1">
            <span className="text-xs font-semibold text-red-400">AI Risk Score</span>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-red-500">{riskScore}%</span>
              <span className="text-xs text-red-400 font-bold uppercase">Disruption</span>
            </div>
          </div>

          <div className="p-4 rounded-xl border border-emerald-500/30 bg-emerald-500/10 space-y-1">
            <span className="text-xs font-semibold text-emerald-400">Model Confidence</span>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-emerald-400">{confidence}%</span>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-950 p-4 space-y-3">
          ...
          <div className="space-y-2 text-xs text-slate-400">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-cyan-400">NOT NULL Constraint Enforced</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-slate-500">Hybrid Rule + Scikit-Learn Model</span>
          </div>
        ...
        <div className="p-4 rounded-xl border border-amber-500/30 bg-amber-500/10 space-y-2">
          ...
          <p className="text-xs text-amber-200 leading-relaxed">{recommendation}</p>
        </div>
